...
globalkeys = gears.table.join(
	...
	end, { description = "open a flameshot", group = "launcher" }),
...
awful.rules.rules = {
	...
	{ rule = { class = "Minecraft Launcher" }, properties = { screen = 1, tag = "4" } },
	{ rule = { class = "Minecraft *" }, properties = { screen = 1, tag = "4" } },
	{ rule = { class = "awakened-poe-trade" }, properties = { floating = true } },
...
-- }}}
-- awful.spawn(flameshot .. " -e flameshot")
awful.spawn.with_shell("flameshot")
awful.spawn.with_shell("picom --backend glx")
-- awful.spawn.with_shell("picom --backend egl")
