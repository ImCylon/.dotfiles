...
---------- common
keymap('n', '<leader>sv', '<cmd>source ~/.config/nvim/init.lua | source ~/.config/nvim/lua/imcylon/plugins/appearance.lua | echo \'RELOAD NVIM!!\'<CR>', opts)
...
keymap('n', '<leader><', '<cmd>BufferLineCyclePrevious<CR>', opts)
